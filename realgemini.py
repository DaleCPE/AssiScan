...
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyA4WqrXJiExEBfFJDH4-ibcQ83GgEuydcE")
genai.configure(api_key=GEMINI_API_KEY)

EMAIL_SENDER = os.getenv("EMAIL_SENDER", "dimaanodalevincent@gmail.com")
EMAIL_PASSWORD = os.getenv("EMAIL_PASSWORD", "zept dmoj jbfb luvb")
...
def get_db_connection():
    try:
        # Kapag nasa Render, gagamitin ang DATABASE_URL link
...
if __name__ == '__main__':
    # Sa local ay port 5000, sa Render ay automatic ang port
